...
export class PostDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipsterSampleApplicationReactApp.post.delete.question'));
...
export default class PostComponentsPage {
  ...
  async deletePost() {
    ...
    expect(await postDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipsterSampleApplicationReactApp.post.delete.question/);
