...
export const TopicDeleteDialog = (props: ITopicDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationReactApp.topic.delete.question">Are you sure you want to delete this Topic?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-topic" color="danger" onClick={confirmDelete}>
